...
class ST:    
    ...
    def read_excel_and_save(self):    
        sheet_name = "产品信息"
        column_name = ["Stamping_Part",
                       "Stamping_Description",
                       "Notes",
                       "Steel_NO",
                       "Steel_Description"]    
...
def job():  
    ...
    dir_file = r"\\schaeffler.com\Taicang\Data\OP-SCA-P3\P32S\08_Summary\15_Segment_IE\冲压集成件需求匹配监控\钢带集成变更_产品信息.xlsx"  
    st_obj = ST(dir_file, sca_dev)  
    st_obj.save_to_sql("Steel_belt_product_information", last_modified_time_record)  
    # 更新全局变量以供下次检查  
